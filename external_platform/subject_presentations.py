...
lab308_presentation = """
	...
	of intelligent agents and multi-agent systems, ambient intelligence tools and environments, context-aware computing,
	machine learning algorithms, applications of social and assistive robotics and swarm intelligence. In 2018 we 
	started a new direction of research devoted to autonomous driving by developing vision and path planning modules for
	an electric car. We believe that AI models and technologies can improve users' experience and systems’ performance 
	in a variety of domains, such as distributed systems, big data, learning platforms, web services, e-business, 
	assisted living, and applications in general. This lab is directed by Professor Adina Magda Florea.
	"""
...
default_presentation = """
	I am sorry, but I don't know nothing about this subject for the moment. Please ask my developers to teach me about
