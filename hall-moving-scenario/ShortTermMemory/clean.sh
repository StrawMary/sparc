...
find -path "*/temporary_aligned_faces_dir/*" -type d -not -name stefania -not -name alex -not -name "." -exec rm -r {} \;
find -path "*/temporary_faces_dir/*" -type d -not -name stefania -not -name alex -not -name "." -exec rm -r {} \;
