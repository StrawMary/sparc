...
class FaceNetDetector:
    def __init__(self, folder_path='./', confidence_threshold=0.6):
        ...
        with tf.Graph().as_default():
            ...
            with self.sess.as_default():
                ...
                classifier_filename = os.path.join(folder_path, 'my_class/my_classifier.pkl')
    ...
    def detect(self, frame):
        ...
        for i in range(detections.shape[0]):
            ...
            if confidence >= self.confidence_threshold:
                ...
                result.append(([bbox[0], bbox[1], bbox[2], bbox[3]], unknown_name, confidence))
